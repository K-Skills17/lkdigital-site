      ...
      <section className="section-premium">
        <div className="max-w-4xl">
          ...
          <p className="text-xl text-muted-foreground leading-relaxed max-w-2xl">
            Nossa equipe realiza uma análise completa da presença digital da sua clínica — sem custo e sem compromisso.
            Você recebe um retorno personalizado em até{" "}
            <span className="text-foreground font-medium">1 dia útil</span>.
            Atendemos no máximo{" "}
            <span className="text-foreground font-medium">5 clínicas por cidade e 1 por município</span>{" "}
      ...
      <section className="py-8 pb-24">
        <div className="grid lg:grid-cols-5 gap-12 lg:gap-20 items-start">
          ...
          <aside className="lg:col-span-2 space-y-12">
            ...
            {/* Exclusivity notice */}
            <div className="bg-trust-bg border border-accent/20 p-6 space-y-4">
              <p className="text-xs font-semibold text-accent uppercase tracking-widest">
                Parceria Exclusiva
              </p>
              <p className="text-sm text-muted-foreground leading-relaxed">
                A LK Digital não atende todas as clínicas que entram em contato. Trabalhamos com no máximo{" "}
                <span className="text-foreground font-medium">5 clínicas por cidade</span>{" "}
                e{" "}
                <span className="text-foreground font-medium">1 por município</span>{" "}
                para garantir atenção total e eliminar conflitos de interesse no seu mercado.
              </p>
              <p className="text-sm text-muted-foreground leading-relaxed">
                A Diagnose é a primeira etapa do nosso processo de seleção. Se houver alinhamento, avançamos juntos.
              </p>
            </div>
          </aside>
